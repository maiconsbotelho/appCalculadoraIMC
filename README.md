...
- Classificação do IMC de acordo com padrões reconhecidos.
- Interface intuitiva e fácil de usar.

## Como Usar

1. Preencha os campos de peso e altura no formulário.
2. Clique no botão "Calcular" para obter seu IMC.
3. O resultado será exibido com a classificação correspondente.
